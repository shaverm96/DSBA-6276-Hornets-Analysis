...
high_risk, revenue, _, hornets_metrics = build_hornets_frame(assets)
reviews_outputs = build_reviews_frame(assets)
reviews_df = reviews_outputs["reviews"]

st.title("From Empty Seats to Higher Revenue")
...
with right:
    st.info(
        ...
        "- Open the XGBoost Analysis page for demand and revenue insights.\n"
        "- Open the Reviews Text Analysis page for customer voice insights.\n"
        "- Use sidebar filters and Gemini sections for executive-ready summaries."
    )
